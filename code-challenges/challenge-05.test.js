...
x describe('Testing challenge 1', () => {
...
x describe('Testing challenge 2', () => {
...
x describe('Testing challenge 3', () => {
...
x describe('Testing challenge 4', () => {
  test('It should return a list of foods', () => {
    expect(splitFoods(gruffaloCrumble)).toStrictEqual(['Gruffalo', 'oats', 'brown sugar', 'flour', 'pure maple syrup', 'chopped nuts', 'baking soda', 'baking powder', 'cinnamon', 'melted butter', 'fresh water']);
  });
});

x describe('Testing challenge 5', () => {
...
x describe('Testing challenge 6', () => {
...
x describe('Testing challenge 7', () => {
...
x describe('Testing challenge 8', () => {
...
x describe('Testing challenge 9', () => {
...
x describe('Testing challenge 10', () => {
  test('It should return the string without vowels', () => {
